...
<!-- banner affiche le titre contact -->
        ...
        <div class="row">      
            ...
            <div class="col-md-12">
                <div class="row cform">
                    ...
                    <!-- la partie qui affiche le map <iframe></iframe> -->
                    <!-- et les contacte de site -->
                    <div class="col-md-4">
                    ...
                    <!-- cest le formulaire de contacte -->
                    <!-- ona cree ce formulaire avec bootstrap est le backend dans youtube -->
                    <div class="col-md-8">
                        <div class="well "style="box-shadow: 1px 1px 1px rgba(0,0,0,.2); background-color: white;">
                                ...
                                if(isset($_POST['envoyer']))
                                {
                                    ...
                                    // verfie si le champ nom est vide
                                    if(empty($_POST['nom']))
                                    {
                                        $valid = 0;
                                    ...
                                    // verfie cest le champs add mail est vide
