...
// si on clic sur connexion il va faire appele a la fenction
...
<div id="touchslider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
                ...
                <div class="carousel-inner" role="listbox" >
                        <div class="item active" style="background-image:url(assets/uploads/photoboutique.jpg">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="slide-text slide_style_right">
                                        <h1 data-animation=""><a href="creeboutique.php" style="color: white;"> cree votre boutique ici</a></h1>
