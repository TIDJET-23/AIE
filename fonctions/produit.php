...
function affiche_produit(){
    ...
    $statement = $pdo->prepare("SELECT
      ...
      FROM table_produit t1
      JOIN table_souscat t2
      ON t1.id_souscat = t2.id_souscat
      JOIN table_cat t3
      ON t2.id_cat = t3.id_categorie
...
function ajouter_produit()
      {
                ...
                if(empty($_POST['idsous_cat'])) {
                    $valid = 0;
                    $message = '<div class="callout callout-danger"><p>selectionnee une sous categorie</p></div>';
                        return $message;
                }
...
function modifie_produit(){
                  ...
                  if(empty($_POST['idsous_cat'])) {
                     $valid = 0;
                     $message = '<div class="callout callout-danger"><p>selectionee une sous categorie</p></div>';
                          return $message;
                  }
...
function affiche_produitboutique(){
    ...
    $statement = $pdo->prepare("SELECT
      ...
      FROM table_produit t1
      JOIN table_souscat t3
      ON t1.id_souscat = t3.id_souscat
      JOIN table_cat t4
      ON t3.id_cat = t4.id_categorie
