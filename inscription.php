...
// cette fenction permet d afficher les pays
include_once "fonctions/rec_pays.php";
        $result=affiche_pays();

$message='';

// si il click sur le botton inscription il va faire appele a la fencion inscription
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="box-shadow: 1px 1px 12px rgba(0,0,0,.1); border-radius: 10px; padding-top: 10px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- select comme combobox -->
                                    <!-- les ligne s appele option cest pas item -->
                                    ...
                                    // foreach permet de dire repeter sil ya tjr des tuple a afficher                      
